...
from . import tcaDecoder, tcaEncoder
from .common import Encoder as E


#
# Purpose: Accepts ICAO Tropical Cyclone Advisory Traditional Alphanumeric Code
...
class Encoder(E.Encoder):
    """Accepts ICAO Tropical Cyclone Advisory Traditional Alphanumeric Code
    form and generates equivalent IWXXM form
