...
from . import vaaDecoder, vaaEncoder
from .common import Encoder as E


#
# Purpose: Accepts ICAO Volcanic Ash Advisory Traditional Alphanumeric Code
# form and generates equivalent IWXXM form
#
...
class Encoder(E.Encoder):
    """Accepts ICAO Volcanic Ash Advisory Traditional Alphanumeric Code form
    and generates equivalent IWXXM form
